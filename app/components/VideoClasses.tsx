      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex justify-center">
          <a
            ...
            className="max-w-xs w-full bg-[rgb(218,165,32)] shadow-[0_0_20px_rgba(218,165,32,0.5),0_25px_50px_-12px_rgba(0,0,0,0.25)] hover:bg-[#C4941A] text-white font-bold text-lg md:text-xl py-4 px-8 rounded-xl transition-colors duration-300 font-sans text-center block"
          >
            QUERO FAZER PARTE!
          </a>
        </div>
